    ...
    const saveVideoInfoToDatabase = async (videoUrl, thumbnailUrl) => {
        try {
            ...
            if (response.status === 201) {
                console.log(
                    "Video information saved to the database.",
                    response.data
                );
            } else {
                console.error(
                    "Failed to save video information to the database."
                );
            }
        } catch (error) {
            console.error(
                "Error saving video information to the database:",
                error
            );
        }
    };
