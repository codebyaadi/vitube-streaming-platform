...
const VideoPage = () => {
    ...
    useEffect(() => {
        ...
        api.get(`/getSingleVideos/${videoId}`) // Replace with your API endpoint
            .then((response) => {
    ...
    return (
        <div
            id="main-container"
            className="flex flex-col md:flex-col lg:flex-row justify-between"
        >
            <div
                id="main-video"
                className="flex flex-col w-full md:w-full lg:w-[70%] font-prompt"
            >
